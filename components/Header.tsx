...
export function Header({
  ...
  return (
    ...
    >
      ...
      <div className="hidden lg:flex items-center justify-between px-4 lg:px-8 py-1.5 text-[11px] bg-gradient-to-r from-[#ED1C24]/20 via-[#040814] to-[#0033CC]/30 border-b border-white/5 text-slate-300 font-mono">
        ...
        <div className="flex items-center gap-4">
          <span className="flex items-center gap-1 text-sky-300">
            <Zap className="w-3 h-3 text-[#0033CC] shrink-0 fill-sky-400" /> Tasa Oficial BCV:{" "}
        ...
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <nav className="hidden md:flex items-center gap-2 lg:gap-3 font-sans">
            <a
              ...
              onClick={() => soundFX.playClick()}
              className="btn-tactile px-3.5 py-2 rounded-xl text-xs font-black uppercase italic text-slate-300 hover:text-white hover:bg-slate-900 border border-transparent hover:border-white/10 transition-all"
            >
              Tarifas & Horarios
            </a>
            ...
            <a
              href="#reservar-qr"
              onClick={() => soundFX.playClick()}
              className="btn-tactile px-3.5 py-2 rounded-xl text-xs font-black uppercase italic text-sky-400 hover:text-sky-300 hover:bg-sky-950/40 border border-sky-500/20 transition-all flex items-center gap-1.5"
            >
          ...
          <div className="flex items-center gap-2 sm:gap-2.5">
            ...
            <button
              ...
              className="btn-tactile p-2 sm:p-2.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-slate-300 hover:text-white border border-white/10 text-xs cursor-pointer"
              title="Panel Gerencial & Recepción"
            >
            ...
            <a
              href="#reservar-qr"
              onClick={() => soundFX.playClick()}
              className="btn-tactile hidden sm:inline-flex items-center gap-1.5 px-5 py-2.5 rounded-2xl bg-[#ED1C24] hover:bg-[#D8001D] text-white font-black text-xs uppercase italic tracking-wider shadow-lg shadow-red-600/30 border border-white/20"
            >
              <QrCode className="w-3.5 h-3.5 text-amber-300" />
              <span>Reservar por QR</span>
            </a>
            ...
            <button
              ...
              className="md:hidden p-2 rounded-xl bg-slate-900 text-slate-300 hover:text-white border border-white/10"
            >
      ...
      {/* Mobile Drawer Menu */}
      {mobileMenuOpen && (
        <div className="md:hidden bg-[#070f1e] border-b-2 border-white/20 px-4 py-4 space-y-2 animate-in slide-in-from-top-2 font-mono">
          <a
            href="#tarifas-oficiales"
            onClick={() => {
              soundFX.playClick();
            ...
            className="block py-2 px-3 rounded-xl text-sm font-bold text-slate-200 hover:bg-slate-900"
          >
            🎳 Tarifas & Horarios
          </a>
          ...
          <a
            ...
            className="block py-2 px-3 rounded-xl text-sm font-bold text-[#ED1C24] bg-red-950/40 border border-red-500/30"
          >
            🎟️ Reservar por QR
          </a>
